...
class SliderRange {
    constructor(video) {
        ...
        // $slider_thumb.mouseenter(() => $('.slider-preview').css({ display: "inline-block" }));
        // $slider_thumb.mouseleave(() => $('.slider-preview').css({ display: "none" }));
...
initPlayer({ Name: "[by d_a_HD] One Piece (701).mp4", folder: { Name: "D:\\anime\\One Piece\\" } })